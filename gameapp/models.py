...
class Game(models.Model):
    ...
    game_feature = models.CharField(max_length=100, blank=True, null=True)
    game_region = models.CharField(max_length=100, blank=True, null=True)
    game_intro = models.TextField(blank=True, null=True)
    game_rule = models.JSONField(blank=True, null=True)
    game_video = models.CharField(max_length=255, blank=True, null=True)
